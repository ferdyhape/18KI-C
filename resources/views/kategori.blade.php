...
@section('content')
    @if (count($kategoris) == 0)
        <p class="my-4">
            Kategori masih kosong, klik <button type="button"
                class="border-0 bg-transparent m-0 p-0 fw-semibold text-primary" data-bs-toggle="modal"
                data-bs-target="#tambahKategori">disini</button> untuk menambahkan
        </p>
    @else
        <div class="card shadow-sm my-4 border-0">
            <div class="card-header d-flex justify-content-between">
                <p class="my-auto">List Kategori</p>
                <button type="button" class="btn btn-primary btn-sm my-1" data-bs-toggle="modal"
                    data-bs-target="#tambahKategori"><i class="bi bi-plus-lg"></i> Tambah
                    Kategori</button>
            </div>

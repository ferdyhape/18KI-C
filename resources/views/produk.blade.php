...
@section('content')
    @if (count($produks) == 0)
        <p class="my-4">
            Produk masih kosong, klik <button type="button" class="border-0 bg-transparent m-0 p-0 fw-semibold text-primary"
                data-bs-toggle="modal" data-bs-target="#tambahproduk">disini</button> untuk menambahkan
        </p>
    @else
        <div class="card shadow-sm my-4 border-0">
            <div class="card-header d-flex justify-content-between">
                <p class="my-auto">List Produk</p>
                <button type="button" class="btn btn-primary btn-sm my-1" data-bs-toggle="modal"
                    data-bs-target="#tambahproduk"><i class="bi bi-plus-lg"></i> Tambah Produk</button>
            </div>
                                                ...
                                                <form action="/produk/{{ $produk['id'] }}" method="post"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <input
                                                                class="form-control my-3 @error('nama') is-invalid @enderror"
                                                        ...
                                                        <div class="form-group">
                                                            <input
                                                                class="form-control my-3 @error('stok') is-invalid @enderror"

                    ...
                    <td>
                        <div class="d-flex justify-content-center gap-2">
                            <a class="btn btn-warning" data-bs-toggle="modal"
                                data-bs-target="#editproduct{{ $produk['id'] }}"><i class="bi bi-pencil-square"></i></a>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form action="/produk/{{ $produk['id'] }}" method="post"
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control my-3 @error('deskripsi') is-invalid @enderror"
                                                    type="text" value="{{ $produk['deskripsi'] }}" name="deskripsi">
                                                @error('deskripsi')
                                                    <div class="form-text">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <input class="form-control my-3 @error('diskon') is-invalid @enderror"
                                            ...
                                            <div class="form-group">
                                                <input class="form-control my-3 @error('harga') is-invalid @enderror"
